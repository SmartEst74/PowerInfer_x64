...
fn main() -> anyhow::Result<()> {
    ...
    let check_tokens = [(73111, " fibonacci"), (727, "def"), (760, "The"), (220, " "), (198, "\\n"), (164042, "teria")];
    ...
    ctx.reset();
    let tokens2: Vec<u32> = vec![727, 73111, 1393, 1590, 198, 262, 413, 307, 2564, 220, 16, 25, 198, 285, 460, 307, 198, 262, 460];
